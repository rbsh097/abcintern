...
const phases = [
  ...
  },
  {
    ...
    description:
      "Our dedicated in-house team ensure compliance at every step.",
    bgColor: "bg-[#F5F5F5]",
    textColor: "text-black",
  },
  {
...
const PhaseCard = ({
  ...
  <div
    ...
    className={`group p-8 md:p-6 rounded-[2rem] flex flex-col gap-12 transition-all duration-500 cursor-default
    ${isActive
        ? "bg-gradient-to-bl from-white to-[#fae57f]"
        : bgColor
      }
    ${className}`}
  >
